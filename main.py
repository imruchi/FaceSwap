...
# from models.diffusionModel import SimpleDiffusionModel
...
#     # Use only the first 2000 images to limit compute
#     num_samples = 2000
#     celeba_subset = Subset(celeba_full, list(range(num_samples)))
#     print(f"Using subset of {num_samples} images.")
    
#     # Split the subset into train, validation, and test sets (70%, 15%, 15%)
...
#     model = SimpleDiffusionModel(in_channels=3, hidden_channels=64).to(device)
